...
dat_clean <- dat_clean |>
   mutate(
    # factor varaibles
    er_status = factor(er_status, levels = c("N","P")),
    pr_status = factor(pr_status, levels = c("N","P")),
    response = factor(response, levels = c("RD","pCR")),
    race = factor(race),
    her2_status = factor(her2_status, levels = c("N","P")),
    her2_ihc = factor(her2_ihc, levels = c("0","1","2","3")),
